...
Java_com_tigerface_perf_anrmonitor_SystemAnrMonitor_hookSignalCatcher(JNIEnv *env,
                                                                                jobject thiz,
                                                                                jobject observed) {
    if(!is_registered){
        glb_env = env;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_tigerface_perf_anrmonitor_SystemAnrMonitor_unHookSignalCatcher(JNIEnv *env,
                                                                                  jobject thiz) {
